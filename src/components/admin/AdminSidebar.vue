<template>
  <div :class="['admin-sidebar', { collapsed: sidebar.isCollapsed }]">
    <div class="sidebar-header">
      <h5 v-if="!sidebar.isCollapsed">Admin</h5>
