        ...
        <div class="card-body">
          ...
          <div class="row text-center">
            <div class="col-3">
              ...
              <small class="d-block mt-2">{{ $t('progress.barber') }}</small>
            </div>
            <div class="col-3">
              <div class="step-indicator" :class="getStepClass(2)">
                <i class="fas fa-scissors"></i>
              </div>
              <small class="d-block mt-2">{{ $t('progress.services') }}</small>
            </div>
            <div class="col-3">
              <div class="step-indicator" :class="getStepClass(3)">
                <i class="fas fa-calendar"></i>
              </div>
              <small class="d-block mt-2">{{ $t('progress.booking') }}</small>
            </div>
            <div class="col-3">
              <div class="step-indicator" :class="getStepClass(4)">
                <i class="fas fa-check"></i>
              </div>
              <small class="d-block mt-2">{{ $t('progress.confirm') }}</small>
            </div>
          </div>
        </div>
      </div>
