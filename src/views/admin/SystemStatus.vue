    ...
    >
      ...
      <div class="card mb-4">
        <div class="card-body d-flex align-items-end flex-wrap justify-content-between gap-3">
          <div>
            <label class="form-label mb-1"><strong>Cleanup Bookings Older Than:</strong></label>
            <div class="d-flex gap-2">
              ...
              <button class="btn btn-danger" @click="confirmManualCleanup">
                <i class="fas fa-trash-alt me-1"></i> Clean Now
              </button>
            </div>
          </div>

          <div>
            <label class="form-label mb-1"><strong>Auto-Cleanup</strong></label>
            <div class="d-flex gap-2 align-items-center">
              ...
              >
                ...
                {{ autoCleanupEnabled ? 'Enabled' : 'Enable Auto-Cleanup' }}
              </button>
            </div>
          </div>
        </div>
      ...
      <div class="modal-overlay" @click.self="showConfirmModal = false">
        <div class="modal-box">
          ...
          <div class="modal-actions">
            ...
            <button class="btn btn-danger w-100" @click="executeConfirmedAction">Confirm</button>
          </div>
        </div>
      </div>
    </template>
