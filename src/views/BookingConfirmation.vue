      ...
      <div class="col-md-8">
        <div class="card">
          <div class="card-header">
            <h3 class="mb-0">
              <i class="fas fa-check-circle me-2"></i>{{ $t('confirmBooking.title') }}
            </h3>
          </div>
          <div class="card-body">
            <div class="row">
            ...
            <div class="d-flex justify-content-between mt-4">
              <button type="button" class="btn btn-secondary" @click="goBack">
                <i class="fas fa-arrow-left me-2"></i>{{ $t('confirmBooking.back') }}
              </button>
              <button
                type="button"
                class="btn btn-dark"
              ...
              >
                <i class="fas fa-check me-2"></i>{{ $t('confirmBooking.confirm') }}
              </button>
            </div>
          </div>
        </div>
